...
async def finish_quiz(message: types.Message, state: FSMContext):
    ...
    # Реакции для каждого возможного результата
    reactions = {
        1: "Оу, 1 из 9 — как первый лайк: немного грустно, но надежда есть! 😅\nНе парься, пересдавай, и зафигачим нормальный результат!",
        2: "Два — уже не полный провал, но и не ультра-бомба. 😜\nДавай, подтягивай знания, и будет огонь!",
        3: "Три — как три подписчика на твой первый пост: маленький, но свой фан-клуб! 😎\nПродолжаем качать, будет лайкать вся лента!",
        4: "Четыре — как четверка по истории в школе: сойдет, но могло бы быть и круче. 📚\nПрокачайся, и сделаем это на “5+”!",
        5: "Пять — уже почти половина! Ты как мем, который начали лайкать. 🔥\nДержи темп, скоро будешь топ-аккаунтом!",
        6: "Шесть — почти профи, как тиктокер с 10к подписчиков. 🎉\nЧуть-чуть усилий — и будешь в трендах!",
        7: "Семь — огонь! Уже почти король (или королева) лайков. 👑\nПродолжай в том же духе — фанаты рядом!",
        8: "Восемь — почти безупречно! Ты как тот чувак, у которого всегда идеальный фильтр. ✨\nПочти хедлайнер нашего фотоклуба!",
        9: "Девять из девяти — БОСС! Ты как инфлюенсер с миллионами подписчиков. 🏆🔥\nВсе ответы — на мази, уважуха!"
    }

    # Получаем соответствующую реакцию
    reaction = reactions.get(score, "Спасибо за участие!")
