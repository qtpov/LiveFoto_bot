            ...
            "dialogs": [
                {
                    ...
                    "responses": {
                        ...
                        2: {"client": "Сергей", "feedback": "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'."},
                        3: {"client": "Нет", "feedback": "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'. Если клиент заведомо не заинтересован в продукте, то ответ 100% будет 'нет'."}
                    },
                    "correct": 0
                },
                {
                ...
                },
                {
                    ...
                    "responses": {
                        ...
                        1: {"client": "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'.", "feedback": ""},
                        2: {"client": "Сначала нужно вызвать эмоции, тогда клиент сам захочет больше фотографий", "feedback": ""},
                        3: {"client": "Сначала покажи фотографии и вызови эмоции, потом предлагай варианты", "feedback": ""}
                    },
                    "correct": 0
                }
            ]
            ...
            "dialogs": [
                {
                    ...
                    "responses": {
                        0: {"client": "Привет! Я, Алина. А я, Вика", "feedback": ""},
                        1: {"client": "Нет.", "feedback": "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'."},
                        2: {"client": "Привет! Я, Алина. А я, Вика", "feedback": "Хотите сфотографироваться?"},
                ...
                },
                {
                    ...
                    "responses": {
                        ...
                        2: {"client": "Девочки такие девочки. Стоит поискать к ним подход.", "feedback": ""},
                        3: {"client": "Нужно быть общительнее", "feedback": ""}
                    },
                    "correct": 0
                },
                {
                    ...
                    "responses": {
                        ...
                        1: {"client": "Не надо, мы стесняемся", "feedback": ""},
                        2: {"client": "Девочки такие девочки. Стоит поискать к ним подход.", "feedback": ""},
                        3: {"client": "Нужно быть общительнее", "feedback": ""}
                    },
                    "correct": 0
...
async def finish_quest16(callback: types.CallbackQuery, state: FSMContext):
    ...
    # Сохраняем результат в БД (ваш код остается без изменений)
    # ...
...
async def request_photo_18(callback: types.CallbackQuery, state: FSMContext):
    ...
    # Сначала отвечаем на callback (чтобы убрать "часики" в интерфейсе)
    await callback.answer()
