...
# Квест 16 - Дожми до результата (обновленная версия)
async def quest_16(callback: types.CallbackQuery, state: FSMContext):
    ...
    scenarios = {
        1: {
            ...
            "dialogs": [
                {
                    "photographer": "Здравствуйте, меня зовут..., как красиво отражаются солнечные лучи! Садитесь скорее рядышком, обалденные кадры получатся!",
                    ...
                    "correct": 0,
                    "feedback": {
                        0: "Отлично! Вы завязали диалог и узнали имена клиентов",
                        1: "Никогда не сдавайся на первом отказе! Ты только что упустил возможность сделать классные кадры.",
                        2: "Заинтересованность клиента угасла в моменте, жаль, кадры сделать не получится.",
                        3: "Теперь клиент думает только о том, что ему придётся что-то купить, а это не самое приятная мысль."
                    }
                },
                {
                    ...
                    "options": [
                        "У тебя получились чудесные семейные кадры в солнечных лучах. Мама растрогана от чувств после крепких объятий и поцелуя сына.",
                        "Хотите посмотреть фотографии?",
                        "Сколько фотографий вам сделать?",
                        "Вам распечатать фотографии или отправить на почту?"
                    ],
                    "correct": 0,
                    "feedback": {
                        0: "Именно ты создал для них эти эмоции, а так же сделала шикарные кадры момента - от покупки таких фотографий Елене будет сложно устоять.",
                        1: "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'.",
                        2: "Сначала нужно вызвать эмоции, тогда клиент сам захочет больше фотографий",
                        3: "Сначала покажи фотографии и вызови эмоции, потом предлагай варианты"
                    }
                }
            ]
        },
        2: {
            ...
            "dialogs": [
                {
                    "photographer": "Здравствуйте, меня зовут ..., скорее вставайте все вместе, потрясающий ракурс для вашей семейной фотографии!",
                    ...
                    "correct": 0,
                    "feedback": {
                        0: "Отличный подход! Вы подчеркнули ценность момента",
                        1: "Никогда не сдавайся на первом отказе! Ты только что упустил возможность сделать классные кадры.",
                        2: "Не надо, спасибо, у неё куча фотографий",
                        3: "Не хотим, спасибо"
                    }
                },
                {
                    "photographer": "Сергей, берите на руки Викторию, Мария, а вы встаньте слегка за могучую спину Сергея и за руку возьмите Викторию, как же вы шикарно смотритесь все вместе! Кадр готов, молодцы!",
                    "client": "Мария, Сергей, а дочку Вика",
                    "options": [
                        "У тебя получились классные семейные кадры, глядя на которые мама увидит себя в психологически комфортном месте",
                        "Хотите посмотреть фотографии?",
                        "Сколько фотографий вам сделать?",
                        "Вам распечатать фотографии или отправить на почту?"
                    ],
                    "correct": 0,
                    "feedback": {
                        0: "Обязательно попробуй поставить семью в разные позы и не забудь сделать им отдельные портреты",
                        1: "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'.",
                        2: "Сначала нужно вызвать эмоции, тогда клиент сам захочет больше фотографий",
                        3: "Сначала покажи фотографии и вызови эмоции, потом предлагай варианты"
                    }
        ...
        3: {
            ...
            "dialogs": [
                {
                    "photographer": "Привет, девчонки! Как настроение? Я (имя), а вас как зовут?",
                    ...
                    "correct": 0,
                    "feedback": {
                        0: "Отличный способ установить контакт!",
                        1: "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'.",
                        2: "Хотите сфотографироваться?",
                        3: "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'."
                    }
                },
                {
                    "photographer": "Видите, я настоящий волшебник, могу все отгадать. А еще я умею делать самые красивые фотографии в мире. Давайте проверим это? Ну-ка обнимитесь быстренько! Класс, ну красотки! А теперь покажите как сильно вы любите друг друга! Ну вообще, крутышки! Смотрите, как здорово получается. А теперь девчонки, расскажите, с кем вы сюда пришли отдыхать? Наверное, с родителями?",
                    "client": "Даааааа!",
                    "options": [
                        "Так побежали скорее к ним, надо вас всех вместе обязательно сфотографировать!",
                        "Круто, можно вас сфотографирую?",
                        "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'.",
                        "Не стоит задавать вопрос, на который можно ответить 'да' или 'нет'."
                    ],
                    "correct": 0,
                    "feedback": {
                        0: "Отличное продолжение диалога! Теперь можно перейти к родителям",
                        1: "Не надо, мы стесняемся",
                        2: "Девочки такие девочки. Стоит поискать к ним подход.",
                        3: "Нужно быть общительнее"
                    }
                },
                {
                    ...
                    "correct": 0,
                    "feedback": {
                        0: "Вы чудесная семья! А теперь, давайте устроим вам настоящую лав-стори.",
                        1: "У девчонок уже есть фотографий, а самые ценные - семейные фотографии сделать не получилось",
                        2: "Заинтересованность клиента угасла в моменте, жаль, кадры сделать не получится.",
                        3: "Нужно быть настойчивее"
                    }
                }
            ]
        }
...
async def show_quest16_scenario(callback: types.CallbackQuery, state: FSMContext):
    ...
    scenario = scenarios.get(current_scenario)
    if not scenario:
        # Все сценарии пройдены
        await finish_quest16(callback, state)
        return

    # Показываем описание сценария перед первым диалогом
    if current_dialog == 0:
        message = await callback.message.answer(
    ...
    message_text = (
        f"📌 Сценарий: {scenario['name']}\n\n"
        f"📷 Фотограф: {dialog['photographer']}\n"
        f"👤 Клиент: {dialog['client']}\n\n"
        "Выберите ваш ответ:"
    )

    message = await callback.message.answer(
        message_text,
        reply_markup=quest16_keyboard(dialog["options"])
    )
...
async def next_quest16_dialog(callback: types.CallbackQuery, state: FSMContext):
    user_data = await state.get_data()
    current_dialog = user_data.get("current_dialog", 0) + 1

    await state.update_data(current_dialog=current_dialog)
    await callback.message.delete()
    await show_quest16_scenario(callback, state)
    await callback.answer()
...
async def handle_quest16_answer(callback: types.CallbackQuery, state: FSMContext):
    ...
    feedback = dialog["feedback"].get(selected_answer, "Нет обратной связи")
    await callback.message.answer(
        f"📌 Обратная связь:\n\n{feedback}"
    )
